...
import com.zeburan.springboot.config.annotation.Logical;
import com.zeburan.springboot.config.annotation.RequiresPermissions;
import com.zeburan.springboot.exception.UnauthorizedException;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.zeburan.springboot.config.annotation.RequiresPermissions)")
