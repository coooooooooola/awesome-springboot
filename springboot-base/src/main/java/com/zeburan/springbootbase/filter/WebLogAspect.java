...
public class WebLogAspect {
    @Pointcut("execution(public * com.zeburan.springbootbase.controller..*.*(..))")
    public void webLog() {
    }

    @Pointcut(" execution(public * com.zeburan.springbootbase.exception.GlobalExceptionHandler.*(..))")
...
//            log.info(jsonObject.toJSONString()); //请求JSON格式日志
        }
    }
